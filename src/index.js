...
app.use('/imagenes', express.static(path.join(__dirname, '../public/css/imagenes')));
...
app.get('/Agape/registerAdmin', (req,res) =>{
   ...
   res.sendFile(path.join(__dirname, '../public/html/Usuarios/registroUsuarios.html'));
})
...
app.get('/Agape/loginAdmin', (req,res) => { 
   ...
   res.sendFile(path.join(__dirname,'../public/html/Usuarios/loginAdmin.html'));
});
...
app.get('/adminHome/verCaracteristicasClinicas', (req,res) => { // la ruta raiz del proyecto o pag principal del sitio
   res.sendFile(path.join(__dirname, '../public/html/CaracteristicasClinicas/verCaracteristicaClinica.html'));//falta rellenar
});

app.get('/adminHome/crearCaracteristicaClinica', (req,res) => { // la ruta raiz del proyecto o pag principal del sitio
   res.sendFile(path.join(__dirname,'../public/html/CaracteristicasClinicas/crearCaractClinica.html'));
});

app.get('/adminHome/modificarCaracteristicaClinica', (req,res) => { // la ruta raiz del proyecto o pag principal del sitio
   res.sendFile(path.join(__dirname,'../public/html/CaracteristicasClinicas/modificarCaractClinica.html'));//falta rellenar
});

//Especialidades Medicas
// servir la pagina html cuando se hace una solicitus get a /adminHome
app.get('/adminHome/verEspecialidades', (req,res) => { // la ruta raiz del proyecto o pag principal del sitio
   res.sendFile(path.join(__dirname,'../public/html/EspecialidadesMedicas/verEspecialidadesMedicas.html'));
});

// servir la pagina html cuando se hace una solicitus get a /adminHome
app.get('/adminHome/crearEspecialidad', (req,res) => { // la ruta raiz del proyecto o pag principal del sitio
   res.sendFile(path.join(__dirname,'../public/html/EspecialidadesMedicas/crearEspecMedica.html'));
});

// servir la pagina html cuando se hace una solicitus get a /adminHome
app.get('/adminHome/modificarEspecialidad', (req,res) => { // la ruta raiz del proyecto o pag principal del sitio
   res.sendFile(path.join(__dirname,'../public/html/EspecialidadesMedicas/modificarEspecMedica.html'));
});

// Estados o Provincias
app.get('/adminHome/verProvincias', (req,res) => {
   res.sendFile(path.join(__dirname, '../public/html/Provincias/verProvincias.html'));
});

app.get('/adminHome/crearProvincias', (req,res) => {
   res.sendFile(path.join(__dirname, '../public/html/Provincias/crearProvincias.html'));
});

app.get('/adminHome/modificarProvincias', (req,res) => {
   res.sendFile(path.join(__dirname, '../public/html/Provincias/modificarProvincia.html'));
});

//Generos
app.get('/adminHome/verGeneros', (req,res) => {
   res.sendFile(path.join(__dirname, '../public/html/Generos/verGeneros.html'));
});

app.get('/adminHome/crearGeneros', (req,res) => {
   res.sendFile(path.join(__dirname, '../public/html/Generos/crearGeneros.html'));
});

app.get('/adminHome/modificarGenero', (req,res) =>{
   res.sendFile(path.join(__dirname, '../public/html/Generos/modificarGenero.html'));
});
